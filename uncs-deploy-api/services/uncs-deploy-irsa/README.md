...
| confServices.principalEnvs.awsSsmParameterClusterNames | string | `"arn:aws:ssm:us-west-2:890013126756:parameter/INFRA_DEPLOY_CLUSTER_NAMES"` |  |
...
| image.repository | string | `"890013126756.dkr.ecr.us-west-2.amazonaws.com/uncs-deploy-irsa"` |  |
| image.tag | string | `"v1"` |  |
